...
using Chad.NLU.GoogleHC;
using Chad.NLU.ExpertAI;
using Chad.FHIR;
...
namespace Chad.CLI
{
    class Program : Runtime
    {
        ...
        {
            CO.WriteLine(FiggleFonts.Chunky.Render("Chad"), Color.Red);
        ...
        {
            Error((Exception)e.ExceptionObject, "Unhandled error occurred during operation. Chad CLI will now shutdown.");
